...
export const towerDeck: Tower[] = [
    ...
    { id: 'tower9', name: 'Cerulean Spire', description: 'A spire reaching the sky with cerulean energy', power: assignRandomPower(), cost: assignRandomCost(), image: 'https://i.imgur.com/AG4O2xF.png' },
    { id: 'tower10', name: 'Ruby Citadel', description: 'A citadel of rubies glowing with fierce power', power: assignRandomPower(), cost: assignRandomCost(), image: 'https://i.imgur.com/rJJkbIt.png' },
    { id: 'tower11', name: 'Topaz Stronghold', description: 'A stronghold of topaz that sparkles brightly', power: assignRandomPower(), cost: assignRandomCost(), image: 'https://i.imgur.com/gPB3VTt.png' },
    { id: 'tower12', name: 'Peridot Tower', description: 'A tower of green peridot infused with earth magic', power: assignRandomPower(), cost: assignRandomCost(), image: 'https://i.imgur.com/UOz5s88.png' },
    { id: 'tower13', name: 'Amethyst Fortress', description: 'A fortress of amethyst filled with mystic power', power: assignRandomPower(), cost: assignRandomCost(), image: 'https://i.imgur.com/zB1BKyK.png' },
    { id: 'tower14', name: 'Bone Keep', description: 'A keep constructed from ancient bones', power: assignRandomPower(), cost: assignRandomCost(), image: 'https://i.imgur.com/AFkHzUP.png' },
    { id: 'tower15', name: 'Crystal Spire', description: 'A spire of pure crystal that shines brightly', power: assignRandomPower(), cost: assignRandomCost(), image: 'https://i.imgur.com/5EeZzxV.png' },
    { id: 'tower16', name: 'Diamond Citadel', description: 'A citadel made of the hardest diamonds', power: assignRandomPower(), cost: assignRandomCost(), image: 'https://i.imgur.com/ayUACbD.png' },
    { id: 'tower17', name: 'Ebony Stronghold', description: 'A stronghold crafted from dark ebony wood', power: assignRandomPower(), cost: assignRandomCost(), image: 'https://i.imgur.com/cvcCIyQ.png' },
    { id: 'tower18', name: 'Frost Tower', description: 'A tower that emanates a chilling frost', power: assignRandomPower(), cost: assignRandomCost(), image: 'https://i.imgur.com/e3Eat5q.png' },
    { id: 'tower19', name: 'Garnet Fortress', description: 'A fortress glowing with red garnet power', power: assignRandomPower(), cost: assignRandomCost(), image: 'https://i.imgur.com/iR5mCbw.png' },
